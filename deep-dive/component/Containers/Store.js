...
class StoreContainer extends Component {
    ...
    render() {
        ...
        return (<div style={{border:'1px solid', padding:'5px'}}>
                    <h2>equivalent of FKEventTemplate.tsx</h2>
                    ...
                    <div style={{ marginTop: 40, borderTop: 'solid 1px grey' }}>
                        ...
                        {meetingDropDown && <div style={{ border: '1px solid green', marginTop: '50px' }}>
                            <h2>meeting dropdown. self managed</h2>
                            {meetingDropDown}</div>}
                        {/* display person*/}
                        <div style={{ border: '1px solid red', marginTop: '50px' }}>
                            <h2>match up event. need parent to tell me what the matchup eventIds are</h2>
