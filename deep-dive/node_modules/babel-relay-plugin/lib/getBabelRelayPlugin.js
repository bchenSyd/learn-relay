      ...
      return {
        visitor: {
          ...
          TaggedTemplateExpression: function TaggedTemplateExpression(path, state) {
            ...
            // var fs = require('fs')
            // var filePath = path.join( __dirname, 'babel-relay-plugin-transform-result.json')
            // fs.appendFile(filePath, JSON.stringify(result),function(err){
            //   console.log('saving file to '+ filePath + 'done.....')
            // })
